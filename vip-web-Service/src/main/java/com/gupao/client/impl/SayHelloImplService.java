 ...
 * 
 */
@WebServiceClient(name = "SayHelloImplService", targetNamespace = "http://impl.vip.gupao.com/", wsdlLocation = "http://localhost:8888/vip/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SAYHELLOIMPLSERVICE_QNAME = new QName("http://impl.vip.gupao.com/", "SayHelloImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8888/vip/hello?wsdl");
    ...
    public SayHelloImpl getSayHelloImplPort() {
        return super.getPort(new QName("http://impl.vip.gupao.com/", "SayHelloImplPort"), SayHelloImpl.class);
    }
    ...
    public SayHelloImpl getSayHelloImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.vip.gupao.com/", "SayHelloImplPort"), SayHelloImpl.class, features);
    }
